...
export const PROJECTS = [
  {
    ...
    metrics:     { before: "Browser sandbox", after: "Full OS + Python", delta: "∞" },
    accent:      "#00d4ff",
    year:        "2024",
    status:      "Open Source",
  },
  {
    ...
    metrics:     { before: "10 browser tabs", after: "1 unified platform", delta: "10×" },
    accent:      "#00ffb3",
    year:        "2024",
    status:      "npm package",
  },
  {
    ...
    metrics:     { before: "Zero Linux support", after: "Upstream driver", delta: "✓" },
    accent:      "#f97316",
    year:        "2025",
    status:      "Upstream",
  },
  ...
  },
  {
    ...
    metrics:     { before: "Boring Quizlet", after: "Actually fun", delta: "∞" },
    accent:      "#a78bfa",
    year:        "2025",
    status:      "Live",
  },
